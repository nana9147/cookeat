...
export async function PATCH(req: NextRequest, { params }: Params) {
  ...
  const { productId: productIdStr, reviewId: reviewIdStr } = await params;
  ...
  if (updateError) {
    console.error('[PATCH /api/products/:id/reviews/:reviewId]', JSON.stringify(updateError));
...
export async function DELETE(req: NextRequest, { params }: Params) {
  ...
  if (deleteError) {
    console.error('[DELETE /api/products/:id/reviews/:reviewId]', JSON.stringify(deleteError));
