...
|                                                데스크탑                                                 |                                                테블릿                                                |                                                모바일                                                |
| :-----------------------------------------------------------------------------------------------------: | :--------------------------------------------------------------------------------------------------: | :--------------------------------------------------------------------------------------------------: |
| <img src="public/screenshots/desktop/seller/dashboard.webp" width="260" alt="판매자 대시보드 데스크탑"> | <img src="public/screenshots/tablet/seller/dashboard.webp" width="200" alt="판매자 대시보드 테블릿"> | <img src="public/screenshots/mobile/seller/dashboard.webp" width="140" alt="판매자 대시보드 모바일"> |

### 판매자 상품 관리

|                                                데스크탑                                                 |                                                테블릿                                                |                                                모바일                                                |
| :-----------------------------------------------------------------------------------------------------: | :--------------------------------------------------------------------------------------------------: | :--------------------------------------------------------------------------------------------------: |
| <img src="public/screenshots/desktop/seller/products.webp" width="260" alt="판매자 상품 관리 데스크탑"> | <img src="public/screenshots/tablet/seller/products.webp" width="200" alt="판매자 상품 관리 테블릿"> | <img src="public/screenshots/mobile/seller/products.webp" width="140" alt="판매자 상품 관리 모바일"> |

### 판매자 주문 관리

|                                               데스크탑                                                |                                               테블릿                                               |                                               모바일                                               |
| :---------------------------------------------------------------------------------------------------: | :------------------------------------------------------------------------------------------------: | :------------------------------------------------------------------------------------------------: |
| <img src="public/screenshots/desktop/seller/orders.webp" width="260" alt="판매자 주문 관리 데스크탑"> | <img src="public/screenshots/tablet/seller/orders.webp" width="200" alt="판매자 주문 관리 테블릿"> | <img src="public/screenshots/mobile/seller/orders.webp" width="140" alt="판매자 주문 관리 모바일"> |

### 판매자 배송 관리

|                                                데스크탑                                                 |                                                테블릿                                                |                                                모바일                                                |
| :-----------------------------------------------------------------------------------------------------: | :--------------------------------------------------------------------------------------------------: | :--------------------------------------------------------------------------------------------------: |
| <img src="public/screenshots/desktop/seller/shipping.webp" width="260" alt="판매자 배송 관리 데스크탑"> | <img src="public/screenshots/tablet/seller/shipping.webp" width="200" alt="판매자 배송 관리 테블릿"> | <img src="public/screenshots/mobile/seller/shipping.webp" width="140" alt="판매자 배송 관리 모바일"> |
...
| 페이지           | 설명                                                              |
| :--------------- | :---------------------------------------------------------------- |
| 📊 **대시보드**  | 매출·주문 현황 요약, 정산 예정 금액, 리뷰 현황                    |
| 📦 **상품 관리** | 상품 등록/수정/삭제, 리치 텍스트 상품 설명, 이미지 다중 업로드    |
| 🧾 **주문 관리** | 주문 조회, 발주확인, 취소/환불 요청 승인·거부·처리                |
| 🚚 **배송 관리** | 배송준비/배송중/배송완료 상태 처리, 운송장 등록·수정, 일괄 업로드 |
| 💬 **문의 관리** | 상품·배송·주문 문의 조회 및 답변                                  |
| ⭐ **리뷰 관리** | 리뷰 열람 및 답글, 부적절 리뷰 신고                               |
| 💰 **정산 관리** | 정산 내역 조회, 기간별 정산 상세                                  |
| 📈 **판매 통계** | 기간별 매출 추이, 상품별 매출 순위, 신규/재구매 고객 비율         |
...
│   ├── seller/               # 판매자 페이지(대시보드, 상품·주문·배송·문의·정산·리뷰·통계)
│   ├── admin/                # 어드민 페이지
